...
This skill ships with the **Flutter BLoC** ai-playbook overlay. Read [platform.md](platform.md) for verify commands and module paths.
...
- [platform.md](platform.md) — Flutter BLoC modules and verify commands
