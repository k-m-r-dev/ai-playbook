...
This skill ships with the **Flutter BLoC** ai-playbook overlay. Read [platform.md](platform.md) for module paths, doc read order, and verification commands.
...
- [platform.md](platform.md) — Flutter BLoC modules and docs
