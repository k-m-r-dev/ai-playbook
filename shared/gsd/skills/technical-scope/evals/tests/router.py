"""Router under test: load_skill(name) over five catalog skills."""
...
CATALOG = {
    "technical-scope": (
        "Use when writing a README, a guide, an RCA, a report, an explanation, "
        "a design doc, a spec, an architecture note, a commit message, or a "
