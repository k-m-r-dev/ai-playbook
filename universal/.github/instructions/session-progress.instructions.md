...
<!-- SYNC: Keep the # Session progress section byte-identical in 20-session-progress.mdc, session-progress-workflow/SKILL.md, and session-progress.instructions.md (universal). -->
