...
This skill ships with the **Native iOS** ai-playbook overlay. Read [platform.md](platform.md) for verify commands and module paths.
...
3. Run verification from [platform.md](platform.md) (per platform.md (xcodebuild test))
...
- [platform.md](platform.md) — Native iOS modules and verify commands
