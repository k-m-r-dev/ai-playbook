---
name: Coder
description: Implement Flutter Riverpod changes following the approved plan and template skills.
tools:
...
- Follow `flutter-riverpod-architecture` for provider/state ownership
