---
name: Planner
description: Analyze a Flutter Riverpod repository and produce a detailed implementation plan before code changes begin.
tools:
...
- Reference `flutter-architecture`, `flutter-riverpod-architecture`, and `native-data-fetching` when relevant
