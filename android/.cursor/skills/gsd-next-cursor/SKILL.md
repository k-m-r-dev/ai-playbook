...
This skill ships with the **Native Android** ai-playbook overlay. Read [platform.md](platform.md) for verify commands and module paths.
...
3. Run verification from [platform.md](platform.md) (e.g. `./gradlew testDebugUnitTest`, `./gradlew lint`)
...
- [platform.md](platform.md) — Native Android modules and verify commands
