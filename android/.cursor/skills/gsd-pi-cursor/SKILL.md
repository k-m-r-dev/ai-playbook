...
This skill ships with the **native Android** ai-playbook overlay. Read [platform.md](platform.md) for module paths, doc read order, and verification commands.
...
- [platform.md](platform.md) — Android modules and docs
