...
# Native Android Implementation Instructions

## Mission

Build maintainable native Android software with clear architecture, strong typing, safe defaults, and reviewable changes.
...
- Keep app wiring, feature logic, shared services, and design system concerns separate
...
- Prefer interface boundaries at system edges, not everywhere by default
