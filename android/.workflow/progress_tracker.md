...
- **Architecture**: (e.g. app module, features, core, design system)
- **Navigation & DI**: (patterns used in this codebase)
- **Data layer**: (Room, DataStore, remote APIs—when applicable)
...
(Databases, entities, migrations, API shapes—only when applicable.)
