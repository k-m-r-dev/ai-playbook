...
This skill ships with the **native iOS** ai-playbook overlay. Read [platform.md](platform.md) for module paths, doc read order, and verification commands.
...
- [platform.md](platform.md) — iOS modules and docs
