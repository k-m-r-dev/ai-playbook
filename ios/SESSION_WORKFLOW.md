...
- Run project verification when code changed: build and tests via `xcodebuild` (scheme, destination, and test bundle per `AGENTS.md`); run `swiftlint` / `swiftformat` when the project uses them.
