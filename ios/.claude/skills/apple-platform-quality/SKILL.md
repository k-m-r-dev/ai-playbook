---
name: apple-platform-quality
description: >
  Quality and safety guidance for native iOS development. Use for concurrency,
...
- Accessibility labels, traits, and dynamic type behavior are considered
- Observability covers failure cases without leaking private data

## Performance Focus

- Avoid repeated parsing, formatting, or layout work in hot paths
- Prefer incremental updates over full-screen reloads where possible
